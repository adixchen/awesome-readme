...
- [bookmarks](https://github.com/CodepediaOrg/bookmarks#readme) - Collection of links to curated public bookmarks from [Ab-testing](https://github.com/CodepediaOrg/bookmarks/blob/master/tagged/ab-testing.md) to [Zsh](https://github.com/CodepediaOrg/bookmarks/blob/master/tagged/zsh.md). 
- [bookmarks.dev](https://github.com/CodepediaOrg/bookmarks.dev#readme) - Project description with supporting links. GIF. Clean screenshots. Simple install instructions. 
